...
int liftpotenmin=430;//400
int liftpotenmax=1790;//1600
int liftpot=1575;
int armpotentiometer=1650;//3450;
int armpo=950;
int thresold=20;
...
void moveLeft(float distance)
{
	...
	while(abs(SensorValue[re])<abs(distanceCalLeftRight(distance)))
	{
		...
		motor[baserearright] =  -127;
		motor[basefrontleft] = -127;///////////////////////////// 100
		motor[baserearleft] =  127;////////////////////////////// 100
	}
	motor[basefrontright] = 0;
	motor[baserearright] = 0;
	motor[basefrontleft] = 0;
	motor[baserearleft] = 0;
}
...
void chock()
{
	motor[basefrontright]=motor[baserearright]=127;
	motor[basefrontleft]=motor[baserearleft]=127;
	wait1Msec(1000);
	motor[basefrontright]=motor[baserearright]=-127;
	motor[basefrontleft]=motor[baserearleft]=-127;
	motor[armMot]=-127;
...
task main()
{
	...
	forwardAndBackward(20,-100);

	forwardInLine();

	forwardAndBackward(50,100);
	...
	time1[T1]=0;while(time1[T1]<2000){}

}

//forwardAndBackward(50,80);

//forwardInLine();

//rotateright(150,100);

//forwardAndBackward(200,100);

//forwardAndBackward(40,-100);

//rotateleft(150,100);

//forwardAndBackward(25,-100);
